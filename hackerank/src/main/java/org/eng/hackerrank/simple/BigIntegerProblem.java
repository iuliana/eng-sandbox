 ...
 *
 * <a href="https://www.hackerrank.com/challenges/java-biginteger/problem">Java BigInteger</a>
 */
public class BigIntegerProblem {
    public static void main(String... args) {
        try (var in = new Scanner(System.in)) {
            ...
            var ai = new BigInteger(a);
            var bi = new BigInteger(b);
            out.println(ai.add(bi));
            out.println(ai.multiply(bi));
        }
    }
}
