...
public class MyRegex {
    ...
    static final String repetition2 = "^[\\d]{1,2}[a-zA-Z]{3,}[\\.]{0,3}+$";
...
/*                var IP = in.next();
                ...
                var rep2 = in.nextLine();
                out.println(isRepetition2(rep2));
            }
        }
    }
    ...
    public static boolean isRepetition2(String in){
        return in.matches(repetition2);
    }
