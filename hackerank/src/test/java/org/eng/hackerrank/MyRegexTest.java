...
public class MyRegexTest {
    ...
    void hrSample() throws IOException {
        ...
        var checker = new MyRegex();
        ins.map(checker::isValidIP).forEach(b -> sb.append(b).append("\n"));
    ...
    void hrRegex2Sample() throws IOException {
        ...
        var sb = new StringBuilder();
        ins.map(MyRegex2::deleteDups).forEach(b -> sb.append(b).append("\n"));
        sb.setLength(sb.length() - 1);
    ...
    void hrRegex3Sample() throws IOException {
        ...
        var sb = new StringBuilder();
        ins.map(ValidUsernameChecker::matches).forEach(b -> sb.append(b).append("\n"));
        sb.setLength(sb.length() - 1);
